...
<head>
    <title>Near Garage - Gearhead Garage</title>
    ...
    <div class="container text-center mt-5">
        ...
        <h3 class="font-alt">
            <a class="dropdown-item" href="php/pages/car_crush.php" target="_blank" title="Click if your car has crushed">
                <i class="material-icons">garage</i> Near Garage
            </a>
        </h3>

        <!-- Description of the service -->
        <p class="text-muted mb-4">
            <span class="badge bg-dark">CAR REPAIRS AND ACCESSORIES!</span> Gearhead Garage connects you swiftly with nearby mechanic shops and specialized auto repair experts.
        </p>
